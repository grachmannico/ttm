  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-list-alt"></i> <span>Kelola Kegiatan</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url()."PPG/tambah_kegiatan"; ?>"><i class="fa fa-plus-square"></i> Tambah Kegiatan</a></li>
            <li><a href="<?php echo base_url()."PPG/mengelola_kegiatan"; ?>"><i class="fa fa-edit"></i> Kelola Data Kegiatan</a></li>
          </ul>
        </li>
